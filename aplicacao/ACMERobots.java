...
public class ACMERobots {
    ...
    public boolean adicionarReserva(Locacao novaLocacao) {
            ...
            for(Locacao l2 : reservas) {
                if(novaLocacao.getNumero() == l2.getNumero()) {
                    return false;
                }
            }
    ...
    public void processarLocacoes() {
        if (listaLocacoes.isEmpty()) {
            ...
            if (primeiraReserva != null) {
                ...
                if(primeiraReserva.getSituacao() != Status.CANCELADA && primeiraReserva.getSituacao() != Status.FINALIZADA) {
        ...
        while (!reservas.isEmpty()) {
            ...
            if (!temRoboRepetido) {
                ...
                if(reservaAtual.getSituacao() != Status.CANCELADA && reservaAtual.getSituacao() != Status.FINALIZADA) {
